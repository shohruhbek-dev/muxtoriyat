...
import {getCategoriesVideosData, postLike, postView,} from "../../services/source";
import {useTranslation} from "react-i18next";
import BackButton from "../../components/BackButton/index.jsx";
import {FiEye, FiSearch} from "react-icons/fi";
import ArticleLoader from "../../components/Spinner/ArticleLoader/index.jsx";
import {EmptyComponent} from "../../components/EmptyData/index.jsx";
...
export default function Videos() {
    ...
    return (
        <>
            <div className="container mx-auto w-[90%] sm:w-[90%] lg:w-[95%] flex gap-4 sm:gap-10 flex-col">
                {/* Qidiruv input */}
