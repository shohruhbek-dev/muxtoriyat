        ...
        <div className="container mx-auto w-[95%] sm:w-full lg:w-[95%] flex gap-4 sm:gap-10 flex-col">
            ...
            <div className="flex items-center rounded-md bg-[#f6f4f4] pl-3 w-full md:w-[30%] my-2 sm:my-5">
                ...
                <input
                    ...
                    className="inline-block grow py-4 px-3 text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm bg-transparent"
                />
                <button onClick={() => {
                    console.log("Search clicked:", tempSearch);
                    setSearch(tempSearch);
                }}
                        className="p-2 rounded hover:bg-gray-200 transition duration-200"
                >
                    <FiSearch size={24} className="text-gray-500 mr-3"/>
                </button>
            </div>
