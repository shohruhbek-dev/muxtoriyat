      ...
      <div className={clsx(cn["firstSec"])}>
        ...
        <div  className={clsx(cn["ulSec"])}>
          <ul>
            ...
            <li><a href="#">Vazirlar</a></li>
            <li><a href="#">Milliy majlis a‘zolari</a></li>

          </ul>
          <ul>
            <li><a href="#">Manbaalar</a></li>
            <li><a href="#">Adabiyotlar</a></li>
            <li><a href="#">Arxiv hujjatlar</a></li>
            <li><a href="#">Matbuot nashrlari</a></li>
            <li><a href="#">Bibliografiya</a></li>
            <li><a href="#">Maqolalar</a></li>

          </ul><ul>
            <li><a href="#">Mediateka</a></li>
            ...
            <li><a href="#">Loyiha ishtirokchilari</a></li>
